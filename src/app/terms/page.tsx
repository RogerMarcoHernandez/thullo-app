...
const TermsOfServicePage = () => (
  <div className="container mx-auto py-8 flex flex-col gap-4 [&_h2]:text-xl px-2">
    ...
    <p>
      By accessing this Website, accessible from https://thullo-app.vercel.app,
    ...
    <p>
      ...
      RMH&apos;s Website for personal, non-commercial transitory viewing only.
    ...
    <ul>
      ...
      <li>
        attempt to reverse engineer any software contained on RMH&apos;s
        Website;
      </li>
      <li>
    ...
    <p>
      This will let RMH to terminate upon violations of any of these
    ...
    <p>
      All the materials on RMH&apos;s Website are provided &quot;as is&quot;.
      RMH makes no warranties, may it be expressed or implied, therefore negates
      all other warranties. Furthermore, RMH does not make any representations
    ...
    <p>
      RMH or its suppliers will not be hold accountable for any damages that
      will arise with the use or inability to use the materials on RMH&apos;s
      Website, even if RMH or an authorize representative of this Website has
    ...
    <p>
      The materials appearing on RMH&apos;s Website may include technical,
      typographical, or photographic errors. RMH will not promise that any of
      the materials in this Website are accurate, complete, or current. RMH may
      change the materials contained on its Website at any time without notice.
      RMH does not make any commitment to update the materials.
    </p>

    <h2>6. Links</h2>

    <p>
      RMH has not reviewed all of the sites linked to its Website and is not
      responsible for the contents of any such linked site. The presence of any
      link does not imply endorsement by RMH of the site. The use of any linked
    ...
    <p>
      RMH may revise these Terms of Use for its Website at any time without
    ...
    <p>
      Any claim related to RMH&apos;s Website shall be governed by the laws of
